...
const Hostingtests = () => (
	<>
		...
		<Slide>
			...
			<Notes>
				Jon: Now supports multiple reports per commit to allow for
				multiple environment types, multiple PHP or database versions,
				operating systems, product levels, etc..
			</Notes>
		</Slide>
	</>
);
